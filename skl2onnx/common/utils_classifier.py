...
def _finalize_converter_classes(scope, argmax_output_name, output_full_name, container, classes):
    """
    ...
    if class_type == onnx_proto.TensorProto.INT32: # int labels
        ...
        apply_cast(scope, reshaped_result_name, output_full_name, container, to=onnx_proto.TensorProto.INT64)
    else: # string labels
        apply_reshape(scope, array_feature_extractor_result_name, output_full_name, container,
