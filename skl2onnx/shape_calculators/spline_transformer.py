...
def calculate_sklearn_spline_transformer(operator):
    ...
    operator.outputs[0].type.shape = [N, model.n_features_out_]


register_shape_calculator(
    "SklearnSplineTransformer", calculate_sklearn_spline_transformer
)
