...
if not os.path.exists(model_file):
    ...
    url = "https://s3.amazonaws.com/onnx-model-zoo/mobilenet/"
    "mobilenetv2-1.0/mobilenetv2-1.0.onnx"
...
data = [{"index": i,
         "label": labels.get(str(i), ('?', '?'))[1], 'score': pred[i]}
        for i in results]
...
if not os.path.exists(filename):
    ...
    import urllib.request
    url = "https://onnxzoo.blob.core.windows.net/models/opset_8/"
    "tiny_yolov2/tiny_yolov2.tar.gz"
...
def display_yolo(img, out, threshold):
    ...
    *threshold* filters out uncertain results.
    ...
    clut = [(0, 0, 0), (255, 0, 0), (255, 0, 255), (0, 0, 255),
            (0, 255, 0), (0, 255, 128),
            (128, 255, 0), (128, 128, 0), (0, 128, 255), (128, 0, 128),
            (255, 0, 128), (128, 0, 255), (255, 128, 128),
