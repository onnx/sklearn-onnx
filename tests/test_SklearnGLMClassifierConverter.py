...
class TestGLMClassifierConverter(unittest.TestCase):
    ...
    def test_model_logistic_regression_binary_class(self):
        ...
        model_onnx = convert(model, 'logistic regression', [('input', FloatTensorType([1, 3]))])
    ...
    def test_model_logistic_regression_multi_class(self):
        ...
        model_onnx = convert(model, 'maximum entropy classifier', [('input', FloatTensorType([1, 3]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_linear_svc_binary_class(self):
        ...
        model_onnx = convert(model, 'linear SVC', [('input', FloatTensorType([1, 3]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_linear_svc_multi_class(self):
        ...
        model_onnx = convert(model, 'multi-class linear SVC', [('input', FloatTensorType([1, 3]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_sgd_binary_class(self):
        ...
        model_onnx = convert(model, 'scikit-learn SGD binary classifier', [('input', FloatTensorType([1, 3]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_sgd_multi_class(self):
        ...
        model_onnx = convert(model, 'scikit-learn SGD multi-class classifier',
    ...
    def test_model_knn_classifier_binary_class(self):
        ...
        model_onnx = convert(model, 'KNN classifier binary', [('input', FloatTensorType([1, 3]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_knn_classifier_multi_class(self):
        ...
        model_onnx = convert(model, 'KNN classifier multi-class', [('input', FloatTensorType([1, 3]))])
        self.assertIsNotNone(model_onnx)
        dump_data_and_model(numpy.atleast_2d(X[0]).astype(numpy.float32), model, model_onnx,
