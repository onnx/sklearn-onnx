...
class TestGLMRegressorConverter(unittest.TestCase):
    ...
    def test_model_linear_regression(self):
        ...
        model_onnx = convert(model, 'linear regression', [('input', FloatTensorType([1, 4]))])
    ...
    def test_model_linear_svr(self):
        ...
        model_onnx = convert(model, 'linear SVR', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_ridge(self):
        ...
        model_onnx = convert(model, 'ridge regression', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_sgd_regressor(self):
        ...
        model_onnx = convert(model, 'scikit-learn SGD regression', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_elastic_net_regressor(self):
        ...
        model_onnx = convert(model, 'scikit-learn elastic-net regression', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_knn_regressor(self):
        ...
        model_onnx = convert(model, 'KNN regressor', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_lasso_lars(self):
        ...
        model_onnx = convert(model, 'lasso lars', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
