...
class TestGLMRegressorConverter(unittest.TestCase):
    ...
    def test_model_linear_regression(self):
        ...
        model_onnx = to_onnx(model, 'linear regression', [('input', FloatTensorType([1, 4]))])
    ...
    def test_model_linear_svr(self):
        ...
        model_onnx = to_onnx(model, 'linear SVR', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_ridge(self):
        ...
        model_onnx = to_onnx(model, 'ridge regression', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_sgd_regressor(self):
        ...
        model_onnx = to_onnx(model, 'scikit-learn SGD regression', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_elastic_net_regressor(self):
        ...
        model_onnx = to_onnx(model, 'scikit-learn elastic-net regression', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
    ...
    def test_model_lasso_lars(self):
        ...
        model_onnx = to_onnx(model, 'lasso lars', [('input', FloatTensorType([1, 4]))])
        self.assertIsNotNone(model_onnx)
